...
>>>>>>> 6481f0e1d675da6123a7e3a7cddf8417566c1cee
```
...
model2 <- lm(formula = log_saleprice ~ SalePrice + GarageFinish + Neighborhood + 
    ...
    MSZoning + GrLivArea + ScreenPorch + OverallCond + YearBuilt + 
    LowQualFinSF + GarageType + Fireplaces + SaleCondition + 
    MasVnrArea + MasVnrType + LotConfig + Fence + BsmtFullBath + 
    X2ndFlrSF + PavedDrive + RoofStyle + SaleType + FullBath + 
    KitchenAbvGr + MSSubClass, data = train1)
