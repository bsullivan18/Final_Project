...
#Taken from Kaggle Competition Discussion (https://www.kaggle.com/c/house-prices-advanced-regression-techniques/discussion/24399)
...
```{r}
lmfull <- lm(model_formula, data=train) #linear model with all variables
